...
Elm.Main.make = function (_elm) {
   ...
   var rotor = F3(function (time,geometry,_p0) {
      ...
      var deltaX = _p2._0;
      var deltaY = _p2._1;
      var pos = {ctor: "_Tuple2",_0: $Basics.fst(_p3) + deltaX,_1: $Basics.snd(_p3) + deltaY};
      var seg = A2($Graphics$Collage.segment,_p3,pos);
      var elm = _U.list([A2($Graphics$Collage.move,
                        _p3,
   ...
   var Geometry = F3(function (a,b,c) {    return {radius: a,omega: b,color: c};});
   var initState = $Dict.fromList(_U.list([{ctor: "_Tuple2",_0: "c1",_1: A3(Geometry,200,0.1,$Color.orange)}
                                          ,{ctor: "_Tuple2",_0: "c2",_1: A3(Geometry,100,0.3,$Color.blue)}
